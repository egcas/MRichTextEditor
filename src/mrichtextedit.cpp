...
#include "include/mrichtextedit.h"
...
MRichTextEdit::MRichTextEdit(QWidget *parent, bool showInsertImage, bool removeFormattingVisible) : QWidget(parent), m_ui(new Ui::MRichTextEdit)
{
        ...
        connect(m_ui->f_textedit, SIGNAL(cursorPositionChanged()),
        ...
        connect(m_ui->f_paragraph, SIGNAL(activated(int)),
        ...
        connect(m_ui->f_fontsize, SIGNAL(activated(QString)),
